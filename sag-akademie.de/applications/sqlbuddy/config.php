...
$sbconfig['DefaultHost'] = MosaikConfig::getVar("dbHost");
$sbconfig['DefaultUser'] = MosaikConfig::getVar("dbUser");
$sbconfig['DefaultPass'] = MosaikConfig::getVar("dbPassword");
$sbconfig['DefaultDatabase'] = MosaikConfig::getVar("dbDatabase");
