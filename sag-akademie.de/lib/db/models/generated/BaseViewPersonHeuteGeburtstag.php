 ...
 */
abstract class BaseViewPersonHeuteGeburtstag extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('view_person_heute_geburtstag');
        ...
        $this->hasColumn('anredestr', 'string', 18, array(
             'type' => 'string',
             'length' => 18,
             'fixed' => false,
             'unsigned' => false,
