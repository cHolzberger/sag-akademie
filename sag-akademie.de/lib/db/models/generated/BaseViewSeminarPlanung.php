 ...
 * @property integer $seminar_art_gesperrt
 * @property integer $standort_gesperrt
 ...
 */
abstract class BaseViewSeminarPlanung extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('view_seminar_planung');
        ...
        $this->hasColumn('seminar_art_gesperrt', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('standort_gesperrt', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('teilnehmer', 'integer', 8, array(
             'type' => 'integer',
             'length' => 8,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('inhouse_firma', 'string', null, array(
             'type' => 'string',
             'fixed' => false,
             'unsigned' => false,
             'primary' => false,
