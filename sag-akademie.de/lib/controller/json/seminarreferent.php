...
class JSON_SeminarReferent extends k_Component {

    /**
     * Table name of the Table this JSON Componentent belongs to
     * @var String
     */
    private $tableName = "SeminarReferent";
	...
	$tbl = Doctrine::getTable($this->tableName);
	$data = $tbl->getReferentenForSeminarId($this->next(), $_GET['standort_id']);
	...
	foreach ($data as $tag) {
	    ...
	    if (!array_key_exists($cTag, $return) || !is_array($return[$cTag]))
		$return [$cTag] = array();
	    $tmp = $tag['Referent'];
	...
	$head[] = array("field" => 'anrede_id', "label" => "ID", "format" => "default");
	$head[] = array("field" => 'grad', "label" => "ID", "format" => "default");
	$head[] = array("field" => 'vorname', "label" => "ID", "format" => "default");
	$head[] = array("field" => 'name', "label" => "ID", "format" => "default");

	$head[] = array("field" => 'email', "label" => "ID", "format" => "default");

	$head[] = array("field" => 'image', "label" => "ID", "format" => "default");
	$head[] = array("field" => 'kuerzel', "label" => "ID", "format" => "default");
