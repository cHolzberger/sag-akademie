<?php
include_once 'konstrukt/adapter.inc.php';
include_once 'konstrukt/charset.inc.php';
include_once 'konstrukt/logging.inc.php';
...
class k_HttpRequest implements k_Context {
  ...
  function cookie($key = null, $default = null) {
    return $key ? $this->cookie_access->get($key, $default) : $this->cookie_access; // MOSAIK FIX: do as described in references
  }
  /**
    * @param string
    * @param mixed   The default value to return, if the value doesn't exist
...
abstract class k_Component implements k_Context {
  ...
  protected $renderers = array(
    ...
    'application/x-download;download' => 'renderDownload',
    'application/pdf;pdf' => 'renderPdf',
    'image/svg+xml;svg' => 'renderSvg',
    'text/iframe;iframe' => 'renderIframe',	
    'text/widget;widget' => 'renderWidget',
