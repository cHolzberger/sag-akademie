...
.PATH_SEPARATOR.dirname(__FILE__)."/../../../lib/html2pdf/");
define("HTML2PS_DIR", dirname(__FILE__)."/../../../lib/html2pdf/");

include_once('config.inc.php');

include_once(HTML2PS_DIR.'stubs.common.inc.php');
include_once(HTML2PS_DIR.'error.php');
include_once(HTML2PS_DIR.'config.parse.php');
