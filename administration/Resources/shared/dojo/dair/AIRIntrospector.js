...
if(!dojo._hasResource["dair.Introspector"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dair.Introspector"] = true;
