...
if(!dojo._hasResource["dair.reloader"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dair.reloader"] = true;
