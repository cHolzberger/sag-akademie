...
if(!dojo._hasResource["dair.File"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare("dair.File", null, {
	...
	//
	// noFile: String
	//		The string used when there is no file available.
	noFile:"[ No File ]",
	//
