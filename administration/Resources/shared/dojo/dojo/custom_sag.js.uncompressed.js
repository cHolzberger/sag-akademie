...
if(typeof dojo=="undefined"){dojo={};};dojo.custom_sag=dojo.custom_sag||{};dojo._loadedModules["dojo.custom_sag"] = dojo.custom_sag;;
if(!dojo._hasResource["dojo.fx.Toggler"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojo.fx.Toggler"] = true;
dojo.fx=dojo.fx||{};dojo.fx.Toggler=dojo.fx.Toggler||{};dojo._loadedModules["dojo.fx.Toggler"] = dojo.fx.Toggler;;
...
dojo.i18n=dojo.i18n||{};dojo._loadedModules["dojo.i18n"] = dojo.i18n;;
...
dojo.string=dojo.string||{};dojo._loadedModules["dojo.string"] = dojo.string;;
...
dojo.regexp=dojo.regexp||{};dojo._loadedModules["dojo.regexp"] = dojo.regexp;;
...
dojo.number=dojo.number||{};dojo._loadedModules["dojo.number"] = dojo.number;;
...
dojo["NodeList-fx"]=dojo["NodeList-fx"]||{};dojo._loadedModules["dojo.NodeList-fx"] = dojo["NodeList-fx"];;
...
if(typeof dijit=="undefined"){dijit={};};dijit._base=dijit._base||{};dijit._base.manager=dijit._base.manager||{};dojo._loadedModules["dijit._base.manager"] = dijit._base.manager;;
...
dojo.Stateful=dojo.Stateful||{};dojo._loadedModules["dojo.Stateful"] = dojo.Stateful;;
...
dijit._WidgetBase=dijit._WidgetBase||{};dojo._loadedModules["dijit._WidgetBase"] = dijit._WidgetBase;;
...
dojo.window=dojo.window||{};dojo._loadedModules["dojo.window"] = dojo.window;;
...
dijit._base.focus=dijit._base.focus||{};dojo._loadedModules["dijit._base.focus"] = dijit._base.focus;;
...
dojo.AdapterRegistry=dojo.AdapterRegistry||{};dojo._loadedModules["dojo.AdapterRegistry"] = dojo.AdapterRegistry;;
...
dijit._base.place=dijit._base.place||{};dojo._loadedModules["dijit._base.place"] = dijit._base.place;;
...
dijit._base.window=dijit._base.window||{};dojo._loadedModules["dijit._base.window"] = dijit._base.window;;
...
dijit._base.popup=dijit._base.popup||{};dojo._loadedModules["dijit._base.popup"] = dijit._base.popup;;
...
dijit._base.scroll=dijit._base.scroll||{};dojo._loadedModules["dijit._base.scroll"] = dijit._base.scroll;;
...
dojo.uacss=dojo.uacss||{};dojo._loadedModules["dojo.uacss"] = dojo.uacss;;
...
dijit._base.sniff=dijit._base.sniff||{};dojo._loadedModules["dijit._base.sniff"] = dijit._base.sniff;;
...
dijit._base.typematic=dijit._base.typematic||{};dojo._loadedModules["dijit._base.typematic"] = dijit._base.typematic;;
...
dijit._base.wai=dijit._base.wai||{};dojo._loadedModules["dijit._base.wai"] = dijit._base.wai;;
...
dijit._Widget=dijit._Widget||{};dojo._loadedModules["dijit._Widget"] = dijit._Widget;;
...
dojo.date=dojo.date||{};dojo.date.stamp=dojo.date.stamp||{};dojo._loadedModules["dojo.date.stamp"] = dojo.date.stamp;;
...
dojo.parser=dojo.parser||{};dojo._loadedModules["dojo.parser"] = dojo.parser;;
...
dojo.cache=dojo.cache||{};dojo._loadedModules["dojo.cache"] = dojo.cache;;
...
dijit._Templated=dijit._Templated||{};dojo._loadedModules["dijit._Templated"] = dijit._Templated;;
...
dijit._Container=dijit._Container||{};dojo._loadedModules["dijit._Container"] = dijit._Container;;
...
dijit._Contained=dijit._Contained||{};dojo._loadedModules["dijit._Contained"] = dijit._Contained;;
...
dijit.layout=dijit.layout||{};dijit.layout._LayoutWidget=dijit.layout._LayoutWidget||{};dojo._loadedModules["dijit.layout._LayoutWidget"] = dijit.layout._LayoutWidget;;
...
dojo.cookie=dojo.cookie||{};dojo._loadedModules["dojo.cookie"] = dojo.cookie;;
...
dijit._CssStateMixin=dijit._CssStateMixin||{};dojo._loadedModules["dijit._CssStateMixin"] = dijit._CssStateMixin;;
...
dijit.form=dijit.form||{};dijit.form._FormWidget=dijit.form._FormWidget||{};dojo._loadedModules["dijit.form._FormWidget"] = dijit.form._FormWidget;;
...
dijit._HasDropDown=dijit._HasDropDown||{};dojo._loadedModules["dijit._HasDropDown"] = dijit._HasDropDown;;
...
dijit.form.Button=dijit.form.Button||{};dojo._loadedModules["dijit.form.Button"] = dijit.form.Button;;
...
dijit.form.ToggleButton=dijit.form.ToggleButton||{};dojo._loadedModules["dijit.form.ToggleButton"] = dijit.form.ToggleButton;;
...
dijit.layout.StackController=dijit.layout.StackController||{};dojo._loadedModules["dijit.layout.StackController"] = dijit.layout.StackController;;
...
dijit.layout.StackContainer=dijit.layout.StackContainer||{};dojo._loadedModules["dijit.layout.StackContainer"] = dijit.layout.StackContainer;;
...
dijit.layout.BorderContainer=dijit.layout.BorderContainer||{};dojo._loadedModules["dijit.layout.BorderContainer"] = dijit.layout.BorderContainer;;
...
dojo.dnd=dojo.dnd||{};dojo.dnd.common=dojo.dnd.common||{};dojo._loadedModules["dojo.dnd.common"] = dojo.dnd.common;;
...
dojo.dnd.autoscroll=dojo.dnd.autoscroll||{};dojo._loadedModules["dojo.dnd.autoscroll"] = dojo.dnd.autoscroll;;
...
dojo.dnd.Mover=dojo.dnd.Mover||{};dojo._loadedModules["dojo.dnd.Mover"] = dojo.dnd.Mover;;
...
dojo.dnd.Moveable=dojo.dnd.Moveable||{};dojo._loadedModules["dojo.dnd.Moveable"] = dojo.dnd.Moveable;;
...
dojo.dnd.move=dojo.dnd.move||{};dojo._loadedModules["dojo.dnd.move"] = dojo.dnd.move;;
...
dojo.dnd.TimedMoveable=dojo.dnd.TimedMoveable||{};dojo._loadedModules["dojo.dnd.TimedMoveable"] = dojo.dnd.TimedMoveable;;
...
dijit.form._FormMixin=dijit.form._FormMixin||{};dojo._loadedModules["dijit.form._FormMixin"] = dijit.form._FormMixin;;
...
dijit._DialogMixin=dijit._DialogMixin||{};dojo._loadedModules["dijit._DialogMixin"] = dijit._DialogMixin;;
...
dijit.DialogUnderlay=dijit.DialogUnderlay||{};dojo._loadedModules["dijit.DialogUnderlay"] = dijit.DialogUnderlay;;
...
dijit.layout._ContentPaneResizeMixin=dijit.layout._ContentPaneResizeMixin||{};dojo._loadedModules["dijit.layout._ContentPaneResizeMixin"] = dijit.layout._ContentPaneResizeMixin;;
...
dojo.html=dojo.html||{};dojo._loadedModules["dojo.html"] = dojo.html;;
...
dijit.layout.ContentPane=dijit.layout.ContentPane||{};dojo._loadedModules["dijit.layout.ContentPane"] = dijit.layout.ContentPane;;
...
dijit.TooltipDialog=dijit.TooltipDialog||{};dojo._loadedModules["dijit.TooltipDialog"] = dijit.TooltipDialog;;
...
dijit.Dialog=dijit.Dialog||{};dojo._loadedModules["dijit.Dialog"] = dijit.Dialog;;
...
dojo.data=dojo.data||{};dojo.data.util=dojo.data.util||{};dojo.data.util.sorter=dojo.data.util.sorter||{};dojo._loadedModules["dojo.data.util.sorter"] = dojo.data.util.sorter;;
...
dojo.data.util.simpleFetch=dojo.data.util.simpleFetch||{};dojo._loadedModules["dojo.data.util.simpleFetch"] = dojo.data.util.simpleFetch;;
...
dojo.data.util.filter=dojo.data.util.filter||{};dojo._loadedModules["dojo.data.util.filter"] = dojo.data.util.filter;;
...
dijit.form.TextBox=dijit.form.TextBox||{};dojo._loadedModules["dijit.form.TextBox"] = dijit.form.TextBox;;
...
dijit.Tooltip=dijit.Tooltip||{};dojo._loadedModules["dijit.Tooltip"] = dijit.Tooltip;;
...
dijit.form.ValidationTextBox=dijit.form.ValidationTextBox||{};dojo._loadedModules["dijit.form.ValidationTextBox"] = dijit.form.ValidationTextBox;;
...
dijit.form.ComboBox=dijit.form.ComboBox||{};dojo._loadedModules["dijit.form.ComboBox"] = dijit.form.ComboBox;;
...
dijit.form.FilteringSelect=dijit.form.FilteringSelect||{};dojo._loadedModules["dijit.form.FilteringSelect"] = dijit.form.FilteringSelect;;
...
dojo.cldr=dojo.cldr||{};dojo.cldr.supplemental=dojo.cldr.supplemental||{};dojo._loadedModules["dojo.cldr.supplemental"] = dojo.cldr.supplemental;;
...
dojo.date.locale=dojo.date.locale||{};dojo._loadedModules["dojo.date.locale"] = dojo.date.locale;;
...
dijit.form.DropDownButton=dijit.form.DropDownButton||{};dojo._loadedModules["dijit.form.DropDownButton"] = dijit.form.DropDownButton;;
...
dijit.Calendar=dijit.Calendar||{};dojo._loadedModules["dijit.Calendar"] = dijit.Calendar;;
...
dijit.form._DateTimeTextBox=dijit.form._DateTimeTextBox||{};dojo._loadedModules["dijit.form._DateTimeTextBox"] = dijit.form._DateTimeTextBox;;
...
dijit.form.DateTextBox=dijit.form.DateTextBox||{};dojo._loadedModules["dijit.form.DateTextBox"] = dijit.form.DateTextBox;;
...
dijit.form._FormSelectWidget=dijit.form._FormSelectWidget||{};dojo._loadedModules["dijit.form._FormSelectWidget"] = dijit.form._FormSelectWidget;;
...
dijit._KeyNavContainer=dijit._KeyNavContainer||{};dojo._loadedModules["dijit._KeyNavContainer"] = dijit._KeyNavContainer;;
...
dijit.MenuItem=dijit.MenuItem||{};dojo._loadedModules["dijit.MenuItem"] = dijit.MenuItem;;
...
dijit.PopupMenuItem=dijit.PopupMenuItem||{};dojo._loadedModules["dijit.PopupMenuItem"] = dijit.PopupMenuItem;;
...
dijit.CheckedMenuItem=dijit.CheckedMenuItem||{};dojo._loadedModules["dijit.CheckedMenuItem"] = dijit.CheckedMenuItem;;
...
dijit.MenuSeparator=dijit.MenuSeparator||{};dojo._loadedModules["dijit.MenuSeparator"] = dijit.MenuSeparator;;
...
dijit.Menu=dijit.Menu||{};dojo._loadedModules["dijit.Menu"] = dijit.Menu;;
...
dijit.form.Select=dijit.form.Select||{};dojo._loadedModules["dijit.form.Select"] = dijit.form.Select;;
...
dijit.form.Form=dijit.form.Form||{};dojo._loadedModules["dijit.form.Form"] = dijit.form.Form;;
...
dijit.form.SimpleTextarea=dijit.form.SimpleTextarea||{};dojo._loadedModules["dijit.form.SimpleTextarea"] = dijit.form.SimpleTextarea;;
...
dijit.form.Textarea=dijit.form.Textarea||{};dojo._loadedModules["dijit.form.Textarea"] = dijit.form.Textarea;;
...
dojo.cldr.monetary=dojo.cldr.monetary||{};dojo._loadedModules["dojo.cldr.monetary"] = dojo.cldr.monetary;;
...
dojo.currency=dojo.currency||{};dojo._loadedModules["dojo.currency"] = dojo.currency;;
...
dijit.form.NumberTextBox=dijit.form.NumberTextBox||{};dojo._loadedModules["dijit.form.NumberTextBox"] = dijit.form.NumberTextBox;;
...
dijit.form.CurrencyTextBox=dijit.form.CurrencyTextBox||{};dojo._loadedModules["dijit.form.CurrencyTextBox"] = dijit.form.CurrencyTextBox;;
...
dijit.form.CheckBox=dijit.form.CheckBox||{};dojo._loadedModules["dijit.form.CheckBox"] = dijit.form.CheckBox;;
...
dijit._editor=dijit._editor||{};dijit._editor.selection=dijit._editor.selection||{};dojo._loadedModules["dijit._editor.selection"] = dijit._editor.selection;;
...
dijit._editor.range=dijit._editor.range||{};dojo._loadedModules["dijit._editor.range"] = dijit._editor.range;;
...
dijit._editor.html=dijit._editor.html||{};dojo._loadedModules["dijit._editor.html"] = dijit._editor.html;;
...
dijit._editor.RichText=dijit._editor.RichText||{};dojo._loadedModules["dijit._editor.RichText"] = dijit._editor.RichText;;
...
dijit.ToolbarSeparator=dijit.ToolbarSeparator||{};dojo._loadedModules["dijit.ToolbarSeparator"] = dijit.ToolbarSeparator;;
...
dijit.Toolbar=dijit.Toolbar||{};dojo._loadedModules["dijit.Toolbar"] = dijit.Toolbar;;
...
dijit._editor._Plugin=dijit._editor._Plugin||{};dojo._loadedModules["dijit._editor._Plugin"] = dijit._editor._Plugin;;
...
dijit._editor.plugins=dijit._editor.plugins||{};dijit._editor.plugins.EnterKeyHandling=dijit._editor.plugins.EnterKeyHandling||{};dojo._loadedModules["dijit._editor.plugins.EnterKeyHandling"] = dijit._editor.plugins.EnterKeyHandling;;
...
dijit.Editor=dijit.Editor||{};dojo._loadedModules["dijit.Editor"] = dijit.Editor;;
...
dijit._editor.plugins.AlwaysShowToolbar=dijit._editor.plugins.AlwaysShowToolbar||{};dojo._loadedModules["dijit._editor.plugins.AlwaysShowToolbar"] = dijit._editor.plugins.AlwaysShowToolbar;;
...
if(typeof dojox=="undefined"){dojox={};};dojox.widget=dojox.widget||{};dojox.widget.Standby=dojox.widget.Standby||{};dojo._loadedModules["dojox.widget.Standby"] = dojox.widget.Standby;;
...
dojo.i18n._preloadLocalizations("dojo.nls.custom_sag", ["ROOT","de","de-de","en","en-us","xx"]);
