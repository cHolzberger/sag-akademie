...
dojo.declare("module.kategorieEditor.KategorieEditor", [mosaik.core.Module], {
	...
	editKategorie: function ( data ) {
		...
		dojo.style ( _t.domNode, "display", "block");
		dojo.style ( this.widgets.saveBtn.domNode, "display", "inline-block" );
		dojo.style ( this.widgets.deleteBtn.domNode, "display", "inline-block" );
	...
	onDelete: function () {
		console.log("Delete");
		sandbox.showLoadingScreen("Daten löschen...");
		
		this.service.deleteKategorie ( this.currentTable, this.currentItem.id ).addCallback( this, "deleteDone");
	},
	...
	deleteDone: function (data) {
		this.loadValues( this.currentTable );
		var _t = this.widgets.editorPane;
		dojo.style ( _t.domNode, "display", "none");
